...
- completion toggling
- API integration flow for `GET`, `POST`, and `PATCH`
...
This covers the extracted UI state helpers used by the React app, including payload building, list updates, and task metadata formatting.
